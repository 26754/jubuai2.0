...
export function GenerationPanel({ selectedScene, onSceneCreated }: GenerationPanelProps) {
  ...
  useEffect(() => {
    ...
    if (defaultStyle !== styleId) {
      console.log('[SceneGen] Initializing style from project/last:', defaultStyle);
  ...
  useEffect(() => {
    ...
    if (shouldSync && projectVisualStyleId && projectVisualStyleId !== styleId) {
      console.log('[SceneGen] Visual style synced from project (auto-follow):', projectVisualStyleId);
